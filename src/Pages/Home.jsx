    ...
    return ( 
        <div className="flex flex-row mx-auto items-center justify-center gap-30 py-20">
            ...
            <div className="w-120 h-120">
                <img src="/src/assets/ken's image.jpg" alt="Ken's Photo" className="w-full h-full object-cover rounded-full transition-all duration-500 ease-in-out hover:shadow-[0_0_60px_cyan]"/>
            </div>
        </div>
     );
}
